...
class TestTools {
    companion object {
        ...
        fun verifySpec(expected: ApplicationSpec, actual: ApplicationSpec) {
            ...
            assertEquals(
                expected.observability?.logging,
                actual.observability?.logging,
                "observability.logging mismatch"
            )
            assertEquals(
                expected.observability?.metrics,
                actual.observability?.metrics,
                "observability.metrics mismatch"
            )
            ...
            assertEquals(
                ...
                actual.strategy?.rollingUpdate,
                "strategy.rollingUpdate mismatch"
            )
